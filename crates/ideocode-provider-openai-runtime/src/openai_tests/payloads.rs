...
fn test_websocket_continuation_request_excludes_transport_fields() {
    ...
    assert_eq!(continuation["prompt_cache_key"], "IDEOCODE-test-cache");
...
/// `.IDEOCODE/prompt-overlay.md`) were silently dropped in ChatGPT/Codex OAuth
