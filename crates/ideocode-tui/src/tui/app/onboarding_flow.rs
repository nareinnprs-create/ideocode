...
/// `IDEOCODE_HOME`/external isolation, matching the import detectors.
...
mod tests {
    ...
    fn external_oauth_present_requires_nonempty_file() {
        let dir = std::env::temp_dir().join(format!("IDEOCODE-onb-test-{}", std::process::id()));
