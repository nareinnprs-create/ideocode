...
def _default_source_root() -> str:
    """<repo>/ios/Sources/IDEOCODEMobile, resolved relative to this file."""
    return str(Path(__file__).resolve().parents[3] / "Sources" / "IDEOCODEMobile")
...
def build_ui_map_from_screenshot(
    ...
    Requires NumPy + PIL. Use it on screenshots under ``/tmp/IDEOCODE-ui-matrix/``.
    """
