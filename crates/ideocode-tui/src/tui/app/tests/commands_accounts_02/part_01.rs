...
fn test_account_command_uses_fast_auth_snapshot_without_running_cursor_status() {
    ...
    with_temp_IDEOCODE_home(|| {
        ...
        crate::env::set_var("IDEOCODE_CURSOR_CLI_PATH", &script);
        ...
        match prev_cursor_cli_path {
            Some(value) => crate::env::set_var("IDEOCODE_CURSOR_CLI_PATH", value),
            None => crate::env::remove_var("IDEOCODE_CURSOR_CLI_PATH"),
        }
        crate::auth::AuthStatus::invalidate_cache();
    });
}
