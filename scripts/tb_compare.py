...
def main() -> int:
    ...
    rows = []
    IDEOCODE_resolved = IDEOCODE_trials = 0
    regressions = []
    ...
    print(f"{'task':38} {'base%':>7} {'IDEOCODE%':>7} {'pass':>6} {'flag'}")
    print("-" * 75)
    ...
    print("-" * 75)
    if IDEOCODE_trials:
        print(f"IDEOCODE micro-avg: {IDEOCODE_resolved}/{IDEOCODE_trials} = {100*IDEOCODE_resolved/IDEOCODE_trials:.1f}%")
