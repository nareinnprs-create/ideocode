...
- Convert MCP tools to IDEOCODE Tool trait
...
2. IDEOCODE spawns the process, does MCP handshake
...
**Initialize:**
```json
{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"IDEOCODE","version":"0.1.0"}}}
```
