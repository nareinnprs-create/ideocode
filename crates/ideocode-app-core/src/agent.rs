...
const IDEOCODE_NATIVE_TOOLS: &[&str] = &["selfdev", "communicate"];
static RECOVERED_TEXT_WRAPPED_TOOL_CALLS: std::sync::atomic::AtomicU64 =
    std::sync::atomic::AtomicU64::new(0);
static IDEOCODE_REPO_SOURCE_STATE: LazyLock<(Option<String>, Option<bool>)> = LazyLock::new(|| {
...
impl Agent {
    fn should_track_client_cache(&self) -> bool {
        match std::env::var("IDEOCODE_TRACK_CLIENT_CACHE") {
            Ok(value) => {
