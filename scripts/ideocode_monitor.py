...
Connects to IDEOCODE's debug socket and displays live streaming events.
Run IDEOCODE serve in one terminal, then this monitor in another.

Usage: ./IDEOCODE_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the IDEOCODE debug socket path"""
