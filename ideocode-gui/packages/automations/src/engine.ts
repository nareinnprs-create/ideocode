...
} from "@ideocode/types/automations"
...
export const automationEngineAttachmentValueSchema: z.ZodType<AutomationEngineAttachmentValue> = z.lazy(() => z.union([
  z.string(),
  z.number().finite(),
  z.boolean(),
  z.null(),
...
export type AutomationEngineCapabilityDeclaration = z.infer<typeof automationEngineCapabilityDeclarationSchema>
...
export type AutomationEngineCapabilityAccess = z.infer<typeof automationEngineCapabilityAccessSchema>
...
export type AutomationEngineAdmissionRequest = z.infer<typeof automationEngineAdmissionRequestSchema>
...
export type AutomationEngineAdmissionReceipt = z.infer<typeof automationEngineAdmissionReceiptSchema>
...
export type AutomationEngineCancellationResult = z.infer<typeof automationEngineCancellationResultSchema>
...
export interface AutomationEngineAdapter {
  ...
  observe(receipt: AutomationEngineAdmissionReceipt, options?: AutomationEngineObserveOptions): AsyncIterable<AutomationEngineEvent>
