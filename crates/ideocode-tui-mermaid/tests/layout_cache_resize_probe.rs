...
//!
//! Run with:
//!   cargo test --release -p IDEOCODE-tui-mermaid --test layout_cache_resize_probe -- --ignored --nocapture
//!
//! NOTE: uses the real IDEOCODE mermaid cache dir (like the crate's unit tests);
