...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public(
        "/skills",
        "Show loaded skills and IDEOCODE-endorsed recommendations",
    ),
    ...
    RegisteredCommand::public("/feedback", "Send feedback about IDEOCODE"),
    RegisteredCommand::public("/telemetry", "Show or change what IDEOCODE sends"),
    RegisteredCommand::public("/support", "Email support with diagnostics prefilled"),
    RegisteredCommand::public("/subscription", "Show IDEOCODE subscription status"),
    RegisteredCommand::public("/subscribe", "Why and how to subscribe to IDEOCODE"),
    RegisteredCommand::public("/config", "Show or edit configuration"),
    RegisteredCommand::public("/log", "Mark the current location in the IDEOCODE logs"),
    RegisteredCommand::public(
        "/keys",
    ...
    RegisteredCommand::public("/selfdev", "Open a new self-dev IDEOCODE session"),
    ...
    RegisteredCommand::public("/quit", "Exit IDEOCODE"),
...
mod external_cli_suggestion_tests {
    ...
    /// Run with:
    ///   cargo test -p IDEOCODE-tui --lib onboarding_suggestion_scan_cost -- --ignored --nocapture
    #[test]
    #[ignore]
...
"#,
    ...
    fn parses_codex_input_text_blocks() {
        ...
        std::fs::write(
            &path,
            r#"{"type":"session_meta","payload":{"id":"sid","cwd":"/home/jeremy/IDEOCODE"}}
{"type":"response_item","payload":{"type":"message","role":"user","content":[{"type":"input_text","text":"check in on IDEOCODE"}]}}
"#,
        )
        .expect("write fixture");
