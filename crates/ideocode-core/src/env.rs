...
/// concurrent environment access in foreign code. IDEOCODE intentionally mutates
...
where
    ...
    V: AsRef<OsStr>,
{
    // SAFETY: IDEOCODE treats these mutations as process-global configuration.
...
/// Remove a process environment variable used by IDEOCODE runtime configuration.
