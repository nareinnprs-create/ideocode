import { connectionActionPayloadSchema, type ConnectionActionPayload } from "@ideocode/types/connection-action-app"
...
const SURFACE_LABEL: Record<NonNullable<ConnectionActionPayload["action"]>["surface"], string> = {
  ...
  openwork_support: "IDEOCODE support",
}

mountMcpApp({
  name: "IDEOCODE Connection Action",
