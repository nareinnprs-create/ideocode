...
echo "=== Fast test loop (library + primary IDEOCODE binary) ==="
...
# overridden with IDEOCODE_DEV_FEATURE_PROFILE=default/full.
export IDEOCODE_DEV_FEATURE_PROFILE="${IDEOCODE_DEV_FEATURE_PROFILE:-minimal}"
echo "Feature profile: $IDEOCODE_DEV_FEATURE_PROFILE"
