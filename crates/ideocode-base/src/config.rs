...
const CONFIG_ENV_KEYS: &[&str] = &[
    "HOME",
    "IDEOCODE_ACP_PROFILE",
    "IDEOCODE_ACP_TOOL_PROFILE",
    "IDEOCODE_ACTIVE_SESSIONS_MANAGER",
    "IDEOCODE_AMBIENT_ENABLED",
    "IDEOCODE_AMBIENT_MAX_INTERVAL",
    "IDEOCODE_AMBIENT_MIN_INTERVAL",
    "IDEOCODE_AMBIENT_MODEL",
    "IDEOCODE_AMBIENT_PROACTIVE",
    "IDEOCODE_AMBIENT_PROVIDER",
    "IDEOCODE_AMBIENT_VISIBLE",
    "IDEOCODE_ANIMATION_FPS",
    "IDEOCODE_AUTOJUDGE_ENABLED",
    "IDEOCODE_AUTOJUDGE_MODEL",
    "IDEOCODE_AUTOREVIEW_ENABLED",
    "IDEOCODE_AUTOREVIEW_MODEL",
    "IDEOCODE_AUTO_SERVER_RELOAD",
    "IDEOCODE_BING_API_KEY",
    "IDEOCODE_BING_API_KEY_ENV",
    "IDEOCODE_BING_MARKET",
    "IDEOCODE_CENTERED_TOGGLE_KEY",
    "IDEOCODE_CHAT_NATIVE_SCROLLBAR",
    "IDEOCODE_COMPACT_NOTIFICATIONS",
    "IDEOCODE_COPY_BADGE_ALT_LABEL",
    "IDEOCODE_COPY_SELECTION_TOGGLE_KEY",
    "IDEOCODE_COPILOT_PREMIUM",
    "IDEOCODE_CROSS_PROVIDER_FAILOVER",
    "IDEOCODE_DEBUG_SOCKET",
    "IDEOCODE_DICTATION_COMMAND",
    "IDEOCODE_DICTATION_KEY",
    "IDEOCODE_DICTATION_MODE",
    "IDEOCODE_DICTATION_TIMEOUT_SECS",
    "IDEOCODE_DIFF_LINE_WRAP",
    "IDEOCODE_DIFF_MODE",
    "IDEOCODE_DIFF_MODE_CYCLE_KEY",
    "IDEOCODE_DIAGRAM_PANE_TOGGLE_KEY",
    "IDEOCODE_DISABLE_BASE_TOOLS",
    "IDEOCODE_DISABLED_ANIMATIONS",
    "IDEOCODE_DISABLED_TOOLS",
    "IDEOCODE_DISCORD_BOT_TOKEN",
    "IDEOCODE_DISCORD_BOT_USER_ID",
    "IDEOCODE_DISCORD_CHANNEL_ID",
    "IDEOCODE_DISCORD_REPLY_ENABLED",
    "IDEOCODE_DISPLAY_CENTERED",
    "IDEOCODE_EFFORT_DECREASE_KEY",
    "IDEOCODE_EFFORT_INCREASE_KEY",
    "IDEOCODE_EMAIL_REPLY_ENABLED",
    "IDEOCODE_EMAIL_TO",
    "IDEOCODE_FOCUS_HOOK",
    "IDEOCODE_GATEWAY_BIND_ADDR",
    "IDEOCODE_GATEWAY_ENABLED",
    "IDEOCODE_GATEWAY_PORT",
    "IDEOCODE_HOME",
    "IDEOCODE_HOOK_PRE_TOOL",
    "IDEOCODE_HOOK_PRE_TOOL_TIMEOUT_MS",
    "IDEOCODE_HOOK_POST_TOOL",
    "IDEOCODE_HOOK_SESSION_END",
    "IDEOCODE_HOOK_SESSION_START",
    "IDEOCODE_HOOK_TURN_END",
    "IDEOCODE_HOOK_TURN_START",
    "IDEOCODE_IDLE_ANIMATION",
    "IDEOCODE_IMAP_HOST",
    "IDEOCODE_INFO_WIDGET_TOGGLE_KEY",
    "IDEOCODE_JADE_RELAY_API_BASE",
    "IDEOCODE_JADE_RELAY_ENABLED",
    "IDEOCODE_JADE_RELAY_LAUNCH_ENABLED",
    "IDEOCODE_JADE_RELAY_LAUNCH_WORKING_DIR",
    "IDEOCODE_JADE_RELAY_REPLY_ENABLED",
    "IDEOCODE_JADE_RELAY_SESSION_ID",
    "IDEOCODE_JADE_RELAY_TOKEN",
    "IDEOCODE_JADE_RELAY_TOKEN_ID",
    "IDEOCODE_JADE_RELAY_USER_ID",
    "IDEOCODE_KV_CACHE_MISS_NOTICES",
    "IDEOCODE_LATEX_RENDERING",
    "IDEOCODE_MARKDOWN_SPACING",
    "IDEOCODE_MEMORY_EMBEDDING_BACKEND",
    "IDEOCODE_MEMORY_EMBEDDING_BASE_URL",
    "IDEOCODE_MEMORY_EMBEDDING_DIM",
    "IDEOCODE_MEMORY_EMBEDDING_MODEL",
    "IDEOCODE_MEMORY_ENABLED",
    "IDEOCODE_ENABLE_MERMAID",
    "IDEOCODE_MEMORY_MODEL",
    "IDEOCODE_MEMORY_SIDECAR_ENABLED",
    "IDEOCODE_PERSIST_MEMORY_INJECTIONS",
    "IDEOCODE_MESSAGE_TIMESTAMPS",
    "IDEOCODE_MODEL",
    "IDEOCODE_MODEL_SWITCH_KEY",
    "IDEOCODE_MODEL_SWITCH_PREV_KEY",
    "IDEOCODE_MOUSE_CAPTURE",
    "IDEOCODE_NEW_TERMINAL_KEY",
    "IDEOCODE_NO_EMOJI",
    "IDEOCODE_NTFY_SERVER",
    "IDEOCODE_NTFY_TOPIC",
    "IDEOCODE_OPENAI_NATIVE_COMPACTION_MODE",
    "IDEOCODE_OPENAI_NATIVE_COMPACTION_THRESHOLD_TOKENS",
    "IDEOCODE_OPENAI_REASONING_EFFORT",
    "IDEOCODE_OPENAI_SERVICE_TIER",
    "IDEOCODE_OPENAI_TRANSPORT",
    "IDEOCODE_ANTHROPIC_REASONING_EFFORT",
    "IDEOCODE_PRESERVE_REASONING_CONTEXT",
    "IDEOCODE_PERFORMANCE",
    "IDEOCODE_PIN_IMAGES",
    "IDEOCODE_PREVENT_SLEEP_WHILE_STREAMING",
    "IDEOCODE_PROVIDER",
    "IDEOCODE_PROMPT_ENTRY_ANIMATION",
    "IDEOCODE_QUEUE_MODE",
    "IDEOCODE_REASONING_DISPLAY",
    "IDEOCODE_REDRAW_FPS",
    "IDEOCODE_SAME_PROVIDER_ACCOUNT_FAILOVER",
    "IDEOCODE_SCROLL_BOOKMARK_KEY",
    "IDEOCODE_SCROLL_DOWN_FALLBACK_KEY",
    "IDEOCODE_SCROLL_DOWN_KEY",
    "IDEOCODE_SCROLL_PAGE_DOWN_KEY",
    "IDEOCODE_SCROLL_PAGE_UP_KEY",
    "IDEOCODE_SCROLL_PROMPT_DOWN_KEY",
    "IDEOCODE_SCROLL_PROMPT_UP_KEY",
    "IDEOCODE_SCROLL_UP_FALLBACK_KEY",
    "IDEOCODE_SCROLL_UP_KEY",
    "IDEOCODE_SEARXNG_URL",
    "IDEOCODE_SHOW_AGENTGREP_OUTPUT",
    "IDEOCODE_SHOW_DIFFS",
    "IDEOCODE_SHOW_THINKING",
    "IDEOCODE_SIDE_PANEL_TOGGLE_KEY",
    "IDEOCODE_SIDE_PANEL_NATIVE_SCROLLBAR",
    "IDEOCODE_SMTP_PASSWORD",
    "IDEOCODE_SPAWN_HOOK",
    "IDEOCODE_STREAM_IDLE_TIMEOUT_SECS",
    "IDEOCODE_SWARM_ENABLED",
    "IDEOCODE_SWARM_MODEL",
    "IDEOCODE_SWARM_MAX_CONCURRENT_AGENTS",
    "IDEOCODE_SWARM_SPAWN_MODE",
    "IDEOCODE_SWARM_STRIP_LAYOUT",
    "IDEOCODE_TELEGRAM_BOT_TOKEN",
    "IDEOCODE_TELEGRAM_CHAT_ID",
    "IDEOCODE_TELEGRAM_REPLY_ENABLED",
    "IDEOCODE_TOOL_CALL_DETAILS",
    "IDEOCODE_TOOL_PROFILE",
    "IDEOCODE_TOOLS",
    "IDEOCODE_TRUSTED_EXTERNAL_AUTH_SOURCES",
    "IDEOCODE_TYPING_SCROLL_LOCK_TOGGLE_KEY",
    "IDEOCODE_UPDATE_CHANNEL",
    "IDEOCODE_WEBSEARCH_ENGINE",
    "IDEOCODE_WEBSEARCH_FALLBACK_ENGINES",
    "IDEOCODE_WORKSPACE_DOWN_KEY",
    "IDEOCODE_WORKSPACE_LEFT_KEY",
    "IDEOCODE_WORKSPACE_RIGHT_KEY",
    "IDEOCODE_WORKSPACE_UP_KEY",
    "XDG_CONFIG_HOME",
];
...
static CONFIG_CACHE: LazyLock<RwLock<ConfigCache>> = LazyLock::new(|| {
    ...
    // (e.g. copilot_premium -> IDEOCODE_COPILOT_PREMIUM), and fingerprinting
...
pub fn config() -> &'static Config {
    ...
    let config = {
        ...
        if cache.force_reload || cache.fingerprint != fingerprint {
            ...
            // (e.g. copilot_premium propagates config -> IDEOCODE_COPILOT_PREMIUM).
...
pub struct Config {
    ...
    /// Global "launch a new IDEOCODE" hotkeys (macOS). Baked once by auto-import.
...
pub struct AcpConfig {
    ...
    pub profile: String,
    /// Tool profile to request when `IDEOCODE acp` starts a daemon itself.
