...
pub mod ui_personality_modes;
pub mod ui_mood;
pub mod ui_themes;
pub mod ui_reactions;
pub mod ui_glass;
pub mod ui_humor;
pub mod ui_preview;
pub mod ui_completion;
pub mod ui_tutorial;
pub mod ui_progressive;
pub mod ui_share;
pub mod ui_quiz;
pub mod ui_voice;
pub mod ui_social;
pub mod ui_integration;
pub mod ui_quick_actions;
pub mod ui_palette;
pub mod ui_scrollbar;
pub mod ui_mascot;
pub mod ui_challenge;
pub mod ui_templates;
pub mod ui_performance;
pub mod ui_theme_api;
pub mod ui_macros;
pub mod ui_import;
pub mod ui_plugins;
pub mod ui_providers;
pub mod ui_image_preview;
pub mod performance;
pub mod ui_widgets;
...
pub mod ui_tool_collapse;
pub mod ui_wordcount;
pub mod ui_timer;
pub mod ui_network;
pub mod ui_theme_picker;
pub mod ui_cinematic;
pub mod ui_git_panel;
pub mod ui_file_explorer;
pub mod ui_search_panel;
pub mod ui_log_viewer;
pub mod ui_build_panel;
pub mod ui_docker;
pub mod ui_cicd;
...
pub trait TuiState {
    ...
    /// Number of IDEOCODE compactions already applied to this session, when known.
...
fn supports_reliable_zero_cache_read_warning(
    ...
    // OpenRouter/IDEOCODE-subscription routes can only be treated as reliable for zero-read
...
pub struct LoginImportPrompt {
    ...
    /// Whether the environment (IDEOCODE_NO_TELEMETRY / DO_NOT_TRACK) already
