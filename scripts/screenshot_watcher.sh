...
# when IDEOCODE signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start IDEOCODE with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/IDEOCODE-screenshots"
...
echo "Enable in IDEOCODE with: /screenshot-mode on"
echo ""
