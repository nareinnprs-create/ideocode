...
-- ever either installed IDEOCODE or did meaningful work in it. We exclude CI traffic
...
SELECT
    -- HEADLINE: real people who installed or meaningfully used IDEOCODE.
    (SELECT COUNT(*) FROM (
    ...
    -- Reach: every distinct non-CI id that ever launched IDEOCODE (incl. empty
