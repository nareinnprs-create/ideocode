...
pub const OPENCODE_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    setup_url: "https://github.com/nareinnprs-create/ideocode#openai-compatible-providers",
...
pub const IDEOCODE_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "IDEOCODE",
    display_name: "IDEOCODE Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
