...
fn main() {
    ...
    println!("cargo:rustc-env=IDEOCODE_DESKTOP_VERSION={version}");
    println!("cargo:rustc-env=IDEOCODE_PRODUCT_VERSION={product_version}");
    println!("cargo:rustc-env=IDEOCODE_DESKTOP_GIT_HASH={git_hash}");
