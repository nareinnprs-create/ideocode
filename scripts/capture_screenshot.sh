...
OUTPUT_NAME="${1:-IDEOCODE-screenshot}"
OUTPUT_PATH="$OUTPUT_DIR/${OUTPUT_NAME}.png"

mkdir -p "$OUTPUT_DIR"

echo "📸 IDEOCODE Screenshot Capture"
echo ""
echo "Instructions:"
echo "  1. Make sure IDEOCODE is running in a visible terminal"
echo "  2. Set up the UI state you want to capture"
echo "  3. Press Enter here, then click on the IDEOCODE window"
echo ""
