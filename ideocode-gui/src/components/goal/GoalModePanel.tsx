  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-3 py-2 border-b border-border-subtle surface-blur flex items-center gap-2">
        ...
        <span className="text-xs font-semibold text-fg-primary">Goal Mode</span>
        {status !== "idle" && (
          <span
        ...
        {!goal ? (
          <div className="space-y-3">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 text-xs rounded-lg border border-border-subtle bg-surface-elevated text-fg-primary placeholder:text-fg-muted focus:outline-none focus:border-accent resize-none"
            />
          ...
          <div className="space-y-3">
            <div className="p-2.5 rounded-lg bg-surface-elevated border border-border-subtle">
              <p className="text-xs text-fg-primary leading-relaxed">{goal}</p>
            </div>
