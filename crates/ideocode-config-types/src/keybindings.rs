...
pub const KEYBINDING_DEFAULTS: &[KeybindingDefault] = &[
    ...
    KeybindingDefault {
        id: "new_terminal",
        description: "Spawn a fresh IDEOCODE session in a new terminal window",
        // Companion to the system-wide launch hotkey (Cmd+; / Alt+;): the
        // shifted variant spawns a new session from inside IDEOCODE, reusing the
    ...
    KeybindingDefault {
        ...
        // Cmd+B is free in IDEOCODE on macOS. On Windows/Linux, Ctrl+R is already
